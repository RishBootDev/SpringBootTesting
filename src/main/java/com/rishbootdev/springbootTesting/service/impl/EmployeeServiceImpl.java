...
import com.rishbootdev.springbootTesting.exceptions.ResourceNotFoundException;
...
public class EmployeeServiceImpl implements EmployeeService {
    ...
    public EmployeeDto createNewEmployee(EmployeeDto employeeDto) {
        ...
        List<Employee> existingEmployees = employeeRepository.getByEmail(employeeDto.getEmail());
